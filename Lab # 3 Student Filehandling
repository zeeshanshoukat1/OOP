...
class students
{
	...
	float cgpa;
		...
		void show2()
		{
			...
			fstream DatainNotepad;                       
            DatainNotepad.open("DatainNotepad", ios::app);                
            if (!DatainNotepad) {                            
            cout<<" Error while creating the file ";          
            }
            else
			{ 
		        DatainNotepad<<"Sap ID : "<<sapId<<endl;
		        DatainNotepad<<"Name : "<<name<<endl;
		        DatainNotepad<<"Semester : "<<semester<<endl;
		        DatainNotepad<<"Cgpa : "<<cgpa<<endl; 
                DatainNotepad.close();                   
            }
			cout<<".............................."<<endl;
		}
...
int main()
{
	...
	s3.show1();
	students s4(43567,"ABDULLAH",2,3.1);
	s4.show2();
	students s5("HASSAN",3.2);
	s5.show3();	
